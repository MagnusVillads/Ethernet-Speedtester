...
start()
starttast=int(input("Press Enter to continue..."))
wh=1
...
while wh==1:
    if starttast==1:
        ...
        print("LAN IP: " + str(ipv4))

        ext_ip = get("https://api.ipify.org").text
        print ("WAN IP:  " + str(ext_ip))
            
        host = "8.8.8.8"
        os.system("ping " + ("-n 4 " if  platform.system().lower()=="windows" else "-c 4 ") + host)
        print (str())
